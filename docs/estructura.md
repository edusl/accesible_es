...
- No debes saltar niveles de jerarquía de encabezados
...
No se debe saltar niveles en esta jerarquía, es decir, el encabezado de nivel inferior a un `h1` debería ser un `h2`
