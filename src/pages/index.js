...
const features = [
  ...
  },  
  {
    ...
    imageUrl: 'img/facil.svg',
    description: (
      <>
        Vamos al grano, nos centramos en las pautas más importantes y las resumimos para que las apliques de forma sencilla.
      </>
    ),
  },
  {
...
function Home() {
  ...
  return (
    <Layout
      title={`La guía de accesibilidad ${siteConfig.title}`}
